...
@section('content-app')
    <div class="card">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6">
                    <h4 class="mb-3"><i class="fa fa-envelope"></i> Surat Keluar</h4>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        @if (in_array($surat->status, ['baru', 'dibaca']) && auth()->user()->level_user == 'kepala_bagian')
                                            <a href="{{ url('surat-keluar/disposisi') . '/' . $surat->id }}"
                                                class="btn btn-success text-white btn-sm" title="Disposisi">
                ...
                <div class="modal-body">
                    <form id="dataForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="mengetahui" name="mengetahui" id="mengetahui" class="form-control"
                                style="width: 100%">
...
@section('js')
    <script>
        const baseUrl = "{{ url('surat-keluar') }}";
        $('#datatable').DataTable({
            processing: true,
        });
        ...
        $(document).on("submit", "#dataForm", function(e) {
            ...
            $.ajax({
                url: "{{ route('surat-keluar.store') }}", // sesuaikan route
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
