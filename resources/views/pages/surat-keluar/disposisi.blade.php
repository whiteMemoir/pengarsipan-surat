        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <h4 class="mb-3"><i class="fa fa-paper-plane"></i> Disposisi Surat Keluar</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 table-responsive">
                            <form method="POST" action="{{ url('disposisi/store?surat=keluar') }}">
                                @csrf
                                ...
                                <div class="form row mb-3">
                                    <label class="col-md-3 text-right" for="kepada">Mengetahui</label>
                                    <div class="form col-md-9">
                                        <input type="text" value="{{ $suratKeluar->knowUser->nama ?? '' }}"
                                ...
                                <div class="form row mb-3">
                                    ...
                                    <div class="form col-md-9">
                                        <input type="text" value="{{ $suratKeluar->fromUser->nama ?? '' }}"
                                            class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form row mb-3">
